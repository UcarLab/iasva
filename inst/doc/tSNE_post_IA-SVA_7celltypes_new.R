...
## ----run_iasva, echo=TRUE, fig.width= 12, fig.height=10------------------
...
## ----find_markers_SV10, echo=TRUE, fig.width=20, fig.height=5------------
...
## ----find_markers2, echo=TRUE, fig.width=6, fig.height=5-----------------
...
## ----run_tsne_post_iasva2, echo=TRUE, fig.width=12, fig.height=10--------
set.seed(3455563)
