...
## Calculate geometric library size, i.e., library size of 
log-transfromed read counts. It is well known that the geometric library size
...
## Run tSNE post IA-SVA analyses, i.e., run tSNE on marker genes associated
with SV1 as detected by IA-SVA. Here, we apply tSNE on the marker genes 
for SV1 obtained from IA-SVA
