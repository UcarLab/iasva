...
```{r run_iasva, echo=TRUE, fig.width= 6, fig.height=6}
...
```{r run_tsne, echo=TRUE, fig.width=8, fig.height=6}
...
```{r run_tsne_post_iasva, echo=TRUE, fig.width=8, fig.height=6}
...
```{r run_pca, echo=TRUE, fig.width=8, fig.height=6}
...
```{r run_sva, echo=TRUE, fig.width=8, fig.height=6}
