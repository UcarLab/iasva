...
#' 
#' study_R2() studies how different R2 thresholds is changging: 1) number of marker genes; 2) clustering quality (assuming number of clusters is known). 
...
study_R2 <- function(Y, iasva.sv, selected.svs=2, no.clusters=2, verbose=FALSE){
